...
public class CommercialPayment {
    ...
    public void selectPayee(String payeePartialName){
        ...
        WebElement payeeOption = Login.driver.findElement(By.cssSelector("div[role='listbox'] div div[title*='ПАОАэрофлот']"));
        payeeOption.click();
    }
    ...
    public static void createCommercialPayment(CommercialPayment paymentForm, String amount, String payeePartialName){
